...
API_URL = "http://20.211.80.65:3000//api/project.all"
api_key = "qXepPtzXqXGUHRQtMiQVccdhPyqlKwgUTsdvVYJKEbfjVyDAHtLYFQYShHuymhYu"
app_name = "job-portal-backend-bxiyc8"
